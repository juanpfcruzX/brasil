...
var formatacoes = require('./formatacoesUtils'),
    ...
    Itau = require('./boleto/bancos/itau'),
    Caixa = require('./boleto/bancos/caixa'),
    Bradesco = require('./boleto/bancos/bradesco'),
	Sicoob = require('./boleto/bancos/sicoob'),

	Gerador = require('./boleto/geradorDeBoleto'),
...
var Beneficiario = (function() {
    ...
    Beneficiario.prototype.comDigitoCodigo = function(_digitoCodigoBeneficiario) {
        this.comDigitoCodigoBeneficiario(_digitoCodigoBeneficiario);
    }

	Beneficiario.prototype.getDigitoContaCorrente = function() {
        // É um alias para getDigitoCodigoBeneficiario
		return this._digitoCodigoBeneficiario;
	}

	Beneficiario.prototype.comDigitoContaCorrente = function(_digitoCodigoBeneficiario) {
        // É um alias para comDigitoCodigoBeneficiario
		this._digitoCodigoBeneficiario = _digitoCodigoBeneficiario;
		return this;
	}
...
var Boleto = (function() {
	...
	function formatarValor(valor) {
		var valor = valor.toString().split('.'),
			inteiros = valor[0],
