...
var GeradorDeBoleto = (function() {
    ...
    var urlDoRepositorioBrasil = 'https://github.com/gammasoft/brasil';
    ...
    var pdfDefaults = {
        ...
        autor: '',
        titulo: '',
        criador: urlDoRepositorioBrasil,
        ...
        creditos: urlDoRepositorioBrasil,
    ...
    GeradorDeBoleto.prototype.gerarPDF = function(args, callback) {
        ...
        var boletos = this._boletos,
            informacoesPersonalizadas = args.informacoesPersonalizadas,
            pdf = new Pdf({
                size: [
                    args.alturaDaPagina,
                ...
                info: {
                    ...
                    Producer: urlDoRepositorioBrasil
                }
            });
        ...
        boletos.forEach(function escreveOsDadosDoBoleto(boleto, indice) {
            ...
            var banco = boleto.getBanco(),
                ...
                enderecoDoBeneficiario = beneficiario.getEndereco(),
            ...
            if(banco.exibirReciboDoPagadorCompleto()) {
                var linha4Opcional = linha3 + espacoEntreLinhas;
            ...
            var primeiraLinhaOpcional = primeiraLinha + espacoEntreLinhas,
            ...
            if(banco.exibirReciboDoPagadorCompleto()) {
                ...
                pdf.font('normal')
                    .fontSize(args.tamanhoDaFonte)
                    .text(gammautils.string.pad(boleto.getNumeroDoDocumentoFormatado(boleto), 8, '0'), args.ajusteX + 181, args.ajusteY + primeiraLinhaOpcional, {
                        lineBreak: false,
                        width: 294,
                        align: 'left'
                    });
            ...
            var segundaLinha = banco.exibirReciboDoPagadorCompleto() ? primeiraLinhaOpcional + espacoEntreLinhas : primeiraLinha + espacoEntreLinhas,
            ...
            pdf.font('normal')
                .fontSize(args.tamanhoDaFonte)
                .text(gammautils.string.pad(banco.getNossoNumeroECodigoDocumento(boleto), 8, '0'), args.ajusteX + 181, args.ajusteY + segundaLinha, {
                    lineBreak: false,
                    width: 294,
                    align: 'left'
                });
            ...
            var segundaLinha2 = linha21 - 20.25,
            ...
            pdf.font('negrito')
                .fontSize(args.tamanhoDaFonteDoTitulo)
                .text('(=) ' + titulos.valorDoDocumento, args.ajusteX + colunaLateral, args.ajusteY + tituloDaSextaLinha, {
                    lineBreak: false,
                    width: tamanhoDasCelulasADireita,
                    align: 'left'
                });
