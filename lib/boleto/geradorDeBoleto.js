    ...
    GeradorDeBoleto.prototype.gerarPDF = function(args, callback) {
        ...
        boletos.forEach(function escreveOsDadosDoBoleto(boleto, indice) {
            ...
            var margemDaLinhaSeparadora = 30,
                divisoresVerticais = linha3 + (2 * margemDaLinhaSeparadora) - 4,
            ...
            var linhaSeparadora = linha3 + margemDaLinhaSeparadora;
            ...
            pdf.font('negrito')
                .fontSize(args.tamanhoDaFonteDoTitulo)
                .text('Nosso Número', args.ajusteX + colunaLateral, args.ajusteY + tituloDaQuintaLinhaLateral, {
                    lineBreak: false,
                    width: 294,
                    align: 'left'
                });
            ...
            pdf.font('negrito')
                .fontSize(args.tamanhoDaFonteDoTitulo)
                .text('Espécie', args.ajusteX + tituloEspecieMoeda, args.ajusteY + tituloDaSextaLinha, {
                    lineBreak: false,
                    width: 294,
                    align: 'left'
                });
            ...
            pdf.font('negrito')
                .fontSize(args.tamanhoDaFonteDoTitulo)
                .text('Quantidade', args.ajusteX + tituloQuantidadeMoeda, args.ajusteY + tituloDaSextaLinha, {
                    lineBreak: false,
                    width: 294,
                    align: 'left'
                });
            ...
            pdf.font('negrito')
                .fontSize(args.tamanhoDaFonteDoTitulo)
                .text('Valor', args.ajusteX + tituloValorMoeda, args.ajusteY + tituloDaSextaLinha, {
                    lineBreak: false,
                    width: 294,
                    align: 'left'
                });
