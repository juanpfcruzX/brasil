...
function extrairDadosDaChaveDeAcesso(chaveDeAcesso) {
    function splitPositionalValues(string, parameters) { // TODO: Mover para o gammautils
        ...
        parameters.forEach(function(parameter) {
            const value = string.substr(startIndex, parameter.length);
...
function calcularDigitoVerificador(chaveDeAcesso){
    const naoTem43Numeros = !/^[0-9]{43}$/.test(chaveDeAcesso), // Para chave de acesso
	...
	const resto  = mUtils.mod(chaveDeAcesso, [2, 3, 4, 5, 6, 7, 8, 9]) % 11;
